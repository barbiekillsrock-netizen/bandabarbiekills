      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative group">
            <img src="/banda-eventos-campinas.webp" alt="Trajetória e história da Banda Barbie Kills, especializada em shows de rock e soul para festas e eventos em Campinas." width={600} height={600} className="w-full h-[500px] lg:h-[600px] object-cover rounded-lg shadow-2xl grayscale group-hover:grayscale-0 transition-all duration-700" loading="lazy" />
            {/* Decorative Border */}
