      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative group">
            <img src="/historia-banda-barbie-kills-campinas.jpg" alt="Banda Barbie Kills com Mariana Chaib tocando ao vivo em evento premium" width={600} height={600} className="w-full h-[500px] lg:h-[600px] object-cover rounded-lg shadow-2xl grayscale group-hover:grayscale-0 transition-all duration-700" loading="lazy" />
            {/* Decorative Border */}
