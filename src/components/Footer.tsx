...
const Footer = () => {
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-8">
          ...
          <div className="flex flex-col items-center lg:items-end gap-2 text-muted-foreground">
            ...
            <div className="flex items-center gap-3"> {/* Adicionado gap maior e garantido items-center */}
  <a 
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="hover:opacity-80 transition-opacity flex items-center" // Adicionado flex e items-center aqui também
    aria-label="WhatsApp"
  >
    <svg 
      ...
      viewBox="0 0 24 24" 
      fill="#25D366" 
      className="w-5 h-5 mb-[2px]" // Esse mb-[2px] faz o ajuste fino para baixo se necessário
    >
