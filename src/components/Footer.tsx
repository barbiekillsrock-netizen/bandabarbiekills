...
<div className="flex flex-col items-center lg:items-end gap-4 text-muted-foreground">
  <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
    ...
    >
      <Mail className="w-4 h-4 text-neon-pink/70 group-hover:text-neon-pink" />
      <span className="font-inter text-sm">barbiekillsrock@gmail.com</span>
    </a>

    <div className="flex items-center gap-4">
      <a href="tel:+5519981736659" className="flex items-center gap-2 hover:text-neon-pink transition-colors group">
        <Phone className="w-4 h-4 text-neon-pink/70 group-hover:text-neon-pink" />
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center bg-[#25D366]/10 p-2 rounded-full hover:bg-[#25D366]/20 transition-all"
        aria-label="WhatsApp"
      >
