  ...
  return <section id="diferencial" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="heading-display text-5xl md:text-6xl lg:text-7xl text-foreground mb-4">QUEM NOS CONTRATA PROCURA<span className="neon-pink-text">CONTRATA</span> PROCURA
          </h2>
