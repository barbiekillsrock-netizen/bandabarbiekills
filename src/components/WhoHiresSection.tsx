...
const features = [
  {
    icon: Star,
    title: 'UMA BANDA',
    description: 'Que faz cada convidado ser parte do show.',
  },
  {
    icon: Music,
    title: 'UM SHOW',
...
const WhoHiresSection = () => {
  return (
    <section id="diferencial" className="relative py-24 lg:py-32 overflow-hidden">
      {/* Parallax Background */}
      <div 
        className="absolute inset-0 parallax-bg"
        style={{ backgroundImage: 'url(/estrutura-show-banda-baile.jpg)' }}
      />
      {/* Dark Overlay */}
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="heading-display text-5xl md:text-6xl lg:text-7xl text-foreground mb-4">
            QUEM NOS <span className="neon-pink-text">CONTRATA</span>
          </h2>
          <p className="subtitle text-lg text-muted-foreground max-w-2xl mx-auto">
            Busca uma experiência única que vai além da música
          </p>
        </div>
