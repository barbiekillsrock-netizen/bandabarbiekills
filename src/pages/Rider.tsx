        ...
        <main className="max-w-5xl mx-auto px-4 md:px-8 py-12 md:py-20 space-y-20">
          ...
          <section className="space-y-12">
            <div className="text-center space-y-3">
              ...
              <p className="text-muted-foreground font-light max-w-2xl mx-auto">
                Equipamentos a serem disponibilizados pelo contratante, caso optem pela contratação do som por conta
                própria.
              </p>
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-4">
              ...
              <ul className="space-y-3 text-sm md:text-base text-foreground/80 font-light list-disc list-inside marker:text-neon-pink">
                ...
                <li>
                  Mesa de som digital operada por técnico capacitado —{" "}
                  <strong className="text-neon-cyan">não aceitamos mesa de som analógica</strong>
                </li>
                <li>
                  5 monitores de chão — caixas ativas de primeira linha: QSC K12.2, EV ZLX12P ou Yamaha DBR12 —{" "}
                  <strong className="text-neon-cyan">não aceitamos Antera nem marcas nacionais</strong>
                </li>
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-4">
              ...
              <ul className="space-y-3 text-sm md:text-base text-foreground/80 font-light list-disc list-inside marker:text-neon-pink">
                ...
                <li>
                  AKG D112 para Bumbo, 2 Shure SM57 para caixa e chimbal, 3 Sennheiser e604 para tons e Shure SM81
                  (over)
                </li>
              </ul>
            </div>
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-4">
              ...
              <ul className="space-y-3 text-sm md:text-base text-foreground/80 font-light list-disc list-inside marker:text-neon-pink">
                <li>
                  Bateria (casco) de marcas importadas de primeira linha: Pearl, DW, Tama, Gretsch, Ludwig, Yamaha
                </li>
                <li>
                  <strong className="text-neon-cyan">Não aceitamos marcas nacionais nem de segunda linha</strong> (RMV,
                  Odery, Michael, Peace, Turbo, etc)
                </li>
                ...
                <li>Peles novas</li>
                <li>
                  A bateria deve estar em perfeito estado de conservação. Não serão aceitas estantes faltando presilhas
                  ou feltros.
                </li>
              </ul>
            </div>
                ...
                <ul className="space-y-3 text-sm text-foreground/80 font-light list-disc list-inside marker:text-neon-pink">
                  ...
                  <li>
                    <strong className="text-neon-cyan">
                      Não aceitamos Roland Jazz Chorus, transistorizados nem marcas nacionais
                    </strong>
                  </li>
                </ul>
              </div>
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-4">
              ...
              <p className="text-foreground/80 font-light">
                Palco de no mínimo <strong className="text-neon-cyan">6 × 3 metros</strong> — sem fissuras, totalmente
                firme, totalmente coberto por carpete com fechamento frontal, lateral e fundos e com escada lateral.
              </p>
            </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-white/10 hover:bg-transparent">
                      <TableHead className="text-neon-cyan font-oswald uppercase tracking-wider text-xs">
                        Canal
                      </TableHead>
                      <TableHead className="text-neon-cyan font-oswald uppercase tracking-wider text-xs">
                        Instrumento / Voz
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-4">
              <h2 className="heading-display text-3xl md:text-4xl text-neon-pink">
                Equipamentos de Responsabilidade da Banda
              </h2>
              <div className="space-y-4">
                <div>
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-4 border-neon-pink/30">
              ...
              <ul className="space-y-3 text-sm text-foreground/80 font-light list-disc list-inside marker:text-neon-cyan">
                <li>
                  A empresa de som responsável pelo evento deve dispor de equipamentos de nível profissional em
                  excelentes condições de funcionamento
                </li>
                <li>
                  O técnico de som da empresa contratada deverá seguir todas as orientações dadas pelo Produtor Musical
                  da banda
                </li>
                ...
                <li>
                  A banda não se responsabiliza por quaisquer danos ocorridos nos equipamentos disponibilizados pela
                  empresa de som contratada
                </li>
                <li>
                  Deve ser disponibilizado local coberto para apresentação, devidamente protegido no caso de chuvas
                </li>
          ...
          <section className="space-y-12">
            <div className="text-center space-y-3">
              ...
              <p className="text-muted-foreground font-light max-w-2xl mx-auto">
                A necessidade do camarim é para que nossa equipe acomode seus equipamentos, consiga ter um descanso e se
                alimente nos intervalos para oferecer a melhor performance possível e realize as trocas de roupa e
                maquiagem.
              </p>
            </div>
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-6 border-neon-cyan/20">
              <p className="text-foreground/70 font-light text-sm italic">
                Em caso de indisponibilidade ou restrições quanto ao camarim do local, avisar previamente para que a
                equipe possa se preparar. A Banda Barbie Kills tem experiência o suficiente para compreender que cada
                evento é único e que cada local oferece uma infraestrutura diferente, portanto, estamos abertos para
                conversar.
              </p>
            </div>
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-4">
              ...
              <ul className="space-y-3 text-sm md:text-base text-foreground/80 font-light list-disc list-inside marker:text-neon-pink">
                <li>
                  Banheiro limpo, sem infiltrações, com vaso, pia, espelho, sabonete, papel higiênico, papel de mão,
                  toalhas limpas e tapete
                </li>
                ...
                <li>
                  Área recomendada: <strong className="text-neon-cyan">16 m² ou maior</strong>
                </li>
                <li>Água potável gelada disponível desde a abertura do local</li>
                <li>
                  A chave do camarim deve ser compartilhada apenas com o Produtor da Banda. O camarim não deve ser
                  compartilhado com demais equipes e/ou artistas.
                </li>
              </ul>
            </div>
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-4">
              ...
              <p className="text-foreground/80 font-light mb-4">
                Os contratantes podem optar livremente por uma das duas opções:
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white/5 rounded-lg p-5 border border-neon-pink/20 space-y-2">
                  ...
                  <p className="text-foreground/70 font-light text-sm">
                    Oferecer o buffet da festa para a equipe da banda — exatamente a mesma alimentação e bebidas que
                    serão oferecidos para os convidados/público. É padrão de mercado os buffets terem valores reduzidos
                    para staff.
                  </p>
                </div>
                <div className="bg-white/5 rounded-lg p-5 border border-neon-pink/20 space-y-2">
                  ...
                  <p className="text-foreground/70 font-light text-sm">
                    Pagamento de <strong className="text-neon-pink">R$ 120,00</strong> por integrante da equipe (músicos
                    e funcionários como carregadores, técnicos de som) referente a alimentação do dia todo.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center space-y-4 pt-8 pb-4">
            ...
            >
              (19) 98284-6842 — Cel e WhatsApp
            </a>
            <br />
            <a
              href="mailto:barbiekillsrock@gmail.com"
              className="text-foreground/60 hover:text-neon-cyan transition-colors font-light text-sm"
            >
